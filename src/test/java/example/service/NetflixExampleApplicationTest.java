...
@SpringBootTest(classes={NetflixExampleApplication.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class NetflixExampleApplicationTest {
